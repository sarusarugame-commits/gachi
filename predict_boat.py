...
# ★★★ 2025年 利益最大化ポートフォリオ (年間+8.8万円) ★★★
# 方針: 1位の自信度をトリガーにして、指定点数をまとめて購入（セット買い）
...
STRATEGY = {
    ...
    5:  {'th': 0.070, 'k': 10}, # 多摩川 (119%) ★広角打法
    
    # 【東海】
    6:  {'th': 0.070, 'k': 2},  # 浜名湖 (130%)
    7:  {'th': 0.070, 'k': 1},  # 蒲郡 (243%) ★スナイパー
    8:  {'th': 0.070, 'k': 8},  # 常滑 (103%)
    9:  {'th': 0.060, 'k': 3},  # 津 (138%)
    10: {'th': 0.070, 'k': 10}, # 三国 (191%) ★最強の稼ぎ頭
    
    # 【近畿・四国・中国】
    11: {'th': 0.045, 'k': 1},  # びわこ (114%) ★数で稼ぐ
    12: {'th': 0.050, 'k': 1},  # 住之江 (123%) ★数で稼ぐ
    13: {'th': 0.065, 'k': 3},  # 尼崎 (111%)
    15: {'th': 0.070, 'k': 1},  # 丸亀 (124%)
    16: {'th': 0.070, 'k': 1},  # 児島 (164%)
    18: {'th': 0.080, 'k': 1},  # 徳山 (298%) ★伝説のスナイパー
...
def predict_race(raw, odds_data=None):
    ...
    # ★ セット買いロジック ★
    # 1位のスコアが閾値(th)を超えていれば、k点を「セット」で購入する
    # ※下位の買い目が閾値割れしていても、保険として買う
